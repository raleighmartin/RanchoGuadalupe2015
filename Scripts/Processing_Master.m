...
GrainSizeArray_Surface = ProcessGrainSize(GrainSizeMetadata_Surface,folder_GrainSize);
GrainSizeArray_BSNE = ProcessGrainSize(GrainSizeMetadata_BSNE,folder_GrainSize);
